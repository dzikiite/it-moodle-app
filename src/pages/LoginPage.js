...
const LoginPage = () => {
  ...
  const handleSubmit = async e => {
    ...
    try {
      ...
      setError('Wystąpił problem z logowaniem, spróbuj później');
    }
  }
            ...
            <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
              ...
              <div className="rounded-md shadow-sm -space-y-px">
                <div>
                  ...
                  <input value={email} onChange={handleChange} id="email" name="email" type="text" required className="appearance-none rounded-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-t-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 sm:text-sm" placeholder="Email" />
                </div>
                <div>
              ...
              <div className="flex items-center justify-end">
                <div className="text-sm">
                  <Link to="/przypomnij-haslo" className="font-medium text-indigo-600 hover:text-indigo-500">
